...
export default function RetrospectStartModal({ onStart }: RetrospectStartModalProps) {
  return (
    <div className="fixed z-50 inset-0 flex items-center justify-center bg-black/50">
      <div className="w-[320px] h-[254px] flex flex-col justify-center items-center gap-6 bg-main-500 rounded-[34px] p-4">
          ...
          <button onClick={onStart} className="w-full h-[42px] bg-white rounded-[100px] text-[14px] font-semibold text-main-500 py-[12px]">시작하기</button>
      </div>
    </div>
  )
}
