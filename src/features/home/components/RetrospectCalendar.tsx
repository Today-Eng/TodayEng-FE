...
export default function RetrospectCalendar({
  ...
  const selectedRetrospect:
    | RetrospectPreviewData
    | null =
    selectedDiary?.diaryStatus ===
      "COMPLETED" &&
    selectedDiary.diaryId !== undefined
      ? {
          diaryId: selectedDiary.diaryId,
          date: selectedDiary.diaryDate,
          dayOfWeek:
            selectedDiary.dayOfWeek,
          keywords:
            selectedDiary.keywords,
          firstQuestion:
            selectedDiary.questionText ?? "",
          firstAnswer:
            selectedDiary.correctedText ?? "",
        }
      : null
